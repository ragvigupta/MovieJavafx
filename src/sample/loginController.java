...
public class loginController extends CommonMethods implements Initializable{
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        loginbtn.setOnMouseEntered(e -> {
            loginbtn.setStyle("-fx-background-color: #FF968A;");
            loginbtn.setEffect(new Bloom(0.85));
        });
        loginbtn.setOnMouseExited(e -> {

            loginbtn.setStyle("-fx-background-color:  #FFAEA5;");
    ...
    public void showDialog(){
        ...
        close.setStyle("-fx-background-color: #FF968A; -fx-text-fill: black");
...
//        JsonObject parser = CommonMethods.connection.getData("Login.jsp", name, value);
        ...
        if(username.equals("ragvi") && password.equals("ragvi")){
           return true;
        } else {
